# Kubernetes Fundamentals Roadmap for AI Engineers

A hands-on learning roadmap for understanding Kubernetes and deploying production-ready AI applications.

## Goal

By completing this roadmap, I will be able to:
...
- Deploy a complete AI application stack.
...
Before learning Kubernetes, I should be comfortable with the following fundamentals.
...
- [ ] Understand localhost and `0.0.0.0`.
- [ ] Understand reverse proxies and load balancers.
- [ ] Use tools such as `curl`, `ping`, and `nslookup`.
...
Create a small FastAPI application and run it using Docker.
